...
@interface SelectPageItem : FormItem <UIPickerViewDataSource,UIPickerViewDelegate> {
    NSString * lookupKey;
}
...
+ (SelectPageItem*)withCell:(UITableViewCell*)lCell andType:(FieldType)ft  withCoreDataKey:(NSString*)key andLookUp:(NSString*)lookup andDelegate:(id<FormTableDelegate>)del;
